...
**Note**: We also have a `form.submit()`. This does not just exists for the `form`, but basically for any DOM element. A lot of events we can also listen to triggered programmatically.
