...
A better way of updating this, is using `insertAdjacentHTML()`. This allows you to target a position and then define which HTML you want to enter. Before we use `insertAdjacentHTML()`, let's see some useful parameters:
