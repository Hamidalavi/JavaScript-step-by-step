...
|Efficient Development & Debugging|More about DOM & Browser APIs|Working with Browser Storage|
|Control Structures (conditions, loops and etc.)|Events (like mouse click, hover and etc.)|Browser Support|
|Compiling in **JavaScript**|More about Functions|**JavaScript** Frameworks|
|Fuctions|More about Numbers & Strings|Meta-programming|
|**D**ocument **O**bject **M**odel (DOM) Bascics|Asynchronous Code|NodeJS Introduction|
|Arrays & Iterables|Background Http (Ajax)|Security|
|Objects|-|Deployment|
