...
In **JavaScript**, `Object` is constructor function. It's also global object that have static properties (`console.dir(Object)`). If you do `console.dir(Object)` you see bunch of properties and methods. These are static methods (everthing you see here in the end are just static methods).

As you learned before, if we add a static property, this simply means that a property is added directly to our constructor function object